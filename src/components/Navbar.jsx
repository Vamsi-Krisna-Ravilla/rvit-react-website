...
function NavBar() {
  ...
  return (
    <>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="ms-auto custom-nav">
              ...
              <NavDropdown title={<><AiOutlineBook /> Academics</>} id="academics-dropdown">
                ...
                <NavDropdown.Divider />
                <NavDropdown title={<><AiOutlineLaptop /> Departments</>} id="departments-dropdown" className="nested-dropdown">
                ...
                <NavDropdown.Divider />
                <NavDropdown title={<><AiOutlineExperiment /> Examinations</>} id="examinations-dropdown" className="nested-dropdown">
              ...
              <NavDropdown title={<><AiOutlineSolution /> Admission</>} id="admission-dropdown">
              ...
              <NavDropdown title={<><AiOutlineEnvironment /> Campus</>} id="campus-dropdown">
                ...
                <NavDropdown.Divider />
                <NavDropdown title={<><AiOutlineHome /> Placements</>} id="placements-dropdown" className="nested-dropdown">
                ...
                <NavDropdown.Divider />
                <NavDropdown title={<><AiOutlineExperiment /> Research</>} id="research-dropdown" className="nested-dropdown">
              ...
              <Nav.Link onClick={handleContactModal}>
      ...
      <Modal show={showContactModal} onHide={handleContactModal}>
        <Modal.Header closeButton>
          <Modal.Title>Contact Us</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p><AiOutlinePhone /> Phone: 9951222238, 48, 68</p>
          <p><AiOutlineMail /> Email: principal@rvit.edu.in</p>
        </Modal.Body>
        <Modal.Footer>
